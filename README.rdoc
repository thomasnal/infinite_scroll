...
See the explain analyze output below, it is taken from postgres console. Due time constraint I left
the test repeatable just semi-automatically. Run `rake db:setup` to generate test data
from 'db/seeds.rb' and execute the explain queries found in the file.
